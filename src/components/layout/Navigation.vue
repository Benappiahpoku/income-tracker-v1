<!--
  Navigation.vue
  Stratonea Income Tracker - Main Navigation Bar
  - Provides navigation links to all main app views.
  - Mobile-first, touch-optimized, and accessible for Ghanaian users.
  - Follows Stratonea guidelines: clear comments, minimal code, and educational structure.
-->
  ...
  <nav class="bg-primary-600 shadow">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between h-16">
        <div class="flex">
          <!-- Stratonea Logo and App Name -->
          <div class="flex-shrink-0 flex items-center">
            <router-link to="/" class="flex items-center space-x-2">
              <StratoneaLogo white />
              <span class="text-xl font-semibold text-white">Income Tracker</span>
            </router-link>
          </div>
          <!-- Desktop Navigation -->
...
/**
 * Navigation.vue
 * - Main navigation bar for the Income Tracker app.
 * - Provides links to all main app views.
 * - Mobile-first, touch-optimized, and accessible.
 */
...
// ===== Navigation Items =====
// Includes all main views and About/Contact at the end
const navItems = [
  { name: 'Home', path: '/' },
  { name: 'Add Income', path: '/new-income' },
  { name: 'Income List', path: '/income-list' },
